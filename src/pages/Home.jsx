  ...
  return (
    <>
      ...
      <section id="hero" style={{ height: '100svh', position: 'relative', overflow: 'hidden' }}>
        {heroSlides.map((s, i) => (
          <div key={i} style={{ position: 'absolute', inset: 0, backgroundImage: `url(${s.img})`, backgroundSize: '100% 100%', backgroundPosition: 'center', opacity: slide === i ? 1 : 0, transition: 'opacity 1.4s ease' }}>
