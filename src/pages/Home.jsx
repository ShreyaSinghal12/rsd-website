...
export default function Home() {
    ...
    const preview = filtered.slice(0, 9)
    ...
    const inputStyle = (focused) => ({
        ...
        border: `1px solid ${focused ? S.gold : 'rgba(26,26,24,0.15)'}`,
    ...
    return (
        <>
            ...
            <section id="hero" style={{ height: '100svh', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: '0 2.5rem 5rem' }}>
                    ...
                    <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 'clamp(2.8rem,7vw,5.5rem)', fontWeight: 400, lineHeight: 1.08, color: S.offwhite, marginBottom: '1.5rem' }}>
                        Where <em style={{ fontStyle: 'italic', color: S.stone }}>space</em><br />becomes story
                    </h1>
                    <p style={{ fontSize: '0.95rem', color: 'rgba(255,255,255,0.92)', maxWidth: 480, marginBottom: '2rem', lineHeight: 1.7 }}>
                    ...
                    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                        <a href="#portfolio" onClick={e => { e.preventDefault(); document.getElementById('portfolio').scrollIntoView({ behavior: 'smooth' }) }}
                            style={{ fontFamily: "'DM Mono',monospace", fontSize: '0.78rem', letterSpacing: '0.14em', textTransform: 'uppercase', padding: '0.9rem 2.2rem', background: S.gold, color: S.ink, textDecoration: 'none', fontWeight: 500, transition: 'background 0.3s', cursor: 'pointer' }}
                        ...
                        <a href="#contact" onClick={e => { e.preventDefault(); document.getElementById('contact').scrollIntoView({ behavior: 'smooth' }) }}
                            style={{ fontFamily: "'DM Mono',monospace", fontSize: '0.78rem', letterSpacing: '0.14em', textTransform: 'uppercase', padding: '0.9rem 2.2rem', border: '1px solid rgba(232,224,208,0.45)', color: S.stone, textDecoration: 'none', transition: 'all 0.3s', cursor: 'pointer' }}
                ...
                <div style={{ position: 'absolute', right: '2.5rem', bottom: '3rem', zIndex: 3, display: 'flex', flexDirection: 'column', gap: 8 }}>
                    {heroSlides.map((_, i) => (
            ...
            <section ref={statsRef} style={{ background: '#F0EBE3', padding: '4rem 0' }}>
                <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem', display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '2rem', textAlign: 'center' }}>
                    {[
            ...
            <section id="about" style={{ padding: '7rem 0', background: S.offwhite }}>
                ...
                {/* How We Work */}
                <div style={{ maxWidth: 1200, margin: '5rem auto 0', padding: '0 2rem' }}>
                    <FadeIn>
                        <span className="gold-rule" />
                ...
                <div style={{ maxWidth: 1300, margin: '0 auto', padding: '0 2rem' }}>
                    ...
                    <div style={{ textAlign: 'center', marginTop: '3rem' }}>
                        <button onClick={() => document.getElementById('portfolio').scrollIntoView({ behavior: 'smooth' })}
                            style={{ fontFamily: "'DM Mono',monospace", fontSize: '0.78rem', letterSpacing: '0.14em', textTransform: 'uppercase', padding: '0.9rem 2.2rem', border: `1px solid #C9A96E`, color: '#C9A96E', background: 'transparent', cursor: 'pointer', transition: 'all 0.3s' }}
            ...
            <section id="testimonials" style={{ background: '#F0EBE3', padding: '7rem 0' }}>
                <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 4rem' }}>
                    <FadeIn>
                        <span className="gold-rule" />
                    ...
                    {/* Card with arrows inside the relative container */}
                    <div style={{ position: 'relative' }}>

                        {/* Left arrow */}
                        <button
                            onClick={() => setTIndex(i => (i - 1 + testimonials.length) % testimonials.length)}
                            style={{ position: 'absolute', left: '-3rem', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', fontSize: '3rem', color: 'rgba(26,26,24,0.35)', transition: 'color 0.25s', lineHeight: 1, padding: 0, zIndex: 2 }}
                            onMouseEnter={e => e.currentTarget.style.color = '#1A1A18'}
                            onMouseLeave={e => e.currentTarget.style.color = 'rgba(26,26,24,0.35)'}>
                            &#8249;
                        </button>

                        {/* Card */}
                        <div style={{ background: '#fff', padding: '2.5rem 3rem', borderLeft: `2px solid ${S.gold}` }}>
                            <p style={{ fontFamily: "'Playfair Display',serif", fontSize: '1.1rem', fontStyle: 'italic', color: S.ink, lineHeight: 1.75, marginBottom: '1.5rem' }}>
                                <span style={{ fontSize: '2.5rem', color: S.gold, lineHeight: 0, verticalAlign: '-0.5rem', marginRight: '0.2rem' }}>"</span>
                        ...
                        <button
                            ...
                            style={{ position: 'absolute', right: '-3rem', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', fontSize: '3rem', color: 'rgba(26,26,24,0.35)', transition: 'color 0.25s', lineHeight: 1, padding: 0, zIndex: 2 }}
                            onMouseEnter={e => e.currentTarget.style.color = '#1A1A18'}
                            onMouseLeave={e => e.currentTarget.style.color = 'rgba(26,26,24,0.35)'}>
                            &#8250;
                        </button>
