...
export default function WhatsAppFloat() {
  ...
  const links = [
    {
      label: 'WhatsApp',
      href: 'https://api.whatsapp.com/send?phone=919800848155',
      bg: '#25D366',
      icon: (
    ...
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/raameshsinghaldesign',
    ...
    {
      label: 'Facebook',
      href: 'https://www.facebook.com/raameshsinghaldesign',
      bg: '#3b5998',
      icon: (
        <svg viewBox="0 0 24 24" fill="white" width="20" height="20">
  ...
  return (
    <div style={{ position: 'fixed', bottom: '1.5rem', right: '1.5rem', zIndex: 50, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
      ...
      {links.map((link, i) => (
          ...
          style={{
            ...
            transition: `all 0.3s ease ${open ? i * 60 : 0}ms`,
          }}
        >
          {link.icon}
        </a>
      ...
      <button
        ...
        style={{
          ...
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          boxShadow: '0 4px 20px rgba(26,26,24,0.35)',
